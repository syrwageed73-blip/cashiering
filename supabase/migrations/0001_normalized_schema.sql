-- =============================================================================
-- Migration 0001: POS normalized relational schema
-- PostgreSQL 17 / Supabase. Runs top-to-bottom on a fresh DB with the `auth`
-- schema present (auth.users). Idempotent; non-destructive.
-- Mirrors supabase/schema.sql. Apply via Supabase Management API SQL endpoint.
